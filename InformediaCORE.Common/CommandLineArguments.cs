...
//        @<file>                             Read options from specified file.
//
...
namespace CommandLine
{
    ...
    public sealed class Parser
    {
        ...
        private ArgumentHelpStrings[] GetAllHelpStrings()
        {
            ...
            strings[index++] = new ArgumentHelpStrings("@<file>", "Read options from specified file.");
            if (this.defaultArgument != null)
        ...
        private bool LexFileArguments(string fileName, out string[] arguments)
        {
            ...
            {
                this.reporter($"Error: Can't open command line argument file '{fileName}' : '{e.Message}'");
                arguments = null;
                return false;
            }
